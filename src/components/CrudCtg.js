...
function CrudCtg() {
    ...
    function ajouterCtg(e) {
        e.preventDefault();
        axios.post('https://lafrancoise221.com/categorie', {
    ...
    function deleteCtg(e, ctg_id) {
        e.preventDefault();
        axios.delete(`https://lafrancoise221.com/categorie/${ctg_id}`);
        setRefresh(true);
    }
    ...
    function renameCtg(e, ctg_id) {
        e.preventDefault();
        let ctg_name = rename;
        axios.put(`https://lafrancoise221.com/categorie/${ctg_id}`, {
        ...
        <div className="container column" id="ctg-action">
            ...
            <div className="container column action" id="crud-ctg">
                <form id="add-ctg" className="container row row-left">
                    <input className="admin-input" onChange={ev => setCreate(ev.target.value)} type="text" name="libelle" placeholder="Nouvelle catégorie" />
